...
public class GameData {
    ...
    private void initializeEquipables() {
        Equipable initialWarriorItem = new Equipable( "Espada enferrujada", 10, 0, 0, 0, 0);
        Equipable initialMageItem = new Equipable( "Cajado Arcano", 5, 0, 2, 2, 0);
        Equipable initialArcherItem = new Equipable( "Arco de Madeira de Lei", 3, 0, 0, 5, 5);
