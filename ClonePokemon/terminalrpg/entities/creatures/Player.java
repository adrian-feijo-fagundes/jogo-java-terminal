...
public class Player extends Creature implements PlayerInterface {
    ...
    public void calcTotalStatus() {
            ...
            this.totalAttack = this.getAttack() + bonusStatus.get("bATK");
            this.setTotalDefense(bonusStatus.get("bDEF"));
            this.totalMana = this.getMana() + bonusStatus.get("bMANA");
            this.setTotalSpeed(this.getSpeed() + bonusStatus.get("bSPD"));
            this.totalLuck = this.getLuck() + bonusStatus.get("bLUCK");
